...
Here is an example of how this file might look like after installing `hello` from Bsdpkgs:
...
[{
  meta = {
    ...
    '';
    maintainers = [{
      email = "edolstra+bsdpkgs@gmail.com";
      github = "edolstra";
      githubId = 1148549;
      name = "Eelco Dolstra";
    }];
...
This information is used by Bsd for querying and updating the package.
