...
`bsd-env --delete-generations` - delete profile generations

# Synopsis

`bsd-env` `--delete-generations` *generations*
...
```console
$ bsd-env --delete-generations 3 4 8
```
...
```console
$ bsd-env --delete-generations 30d
```
...
```console
$ bsd-env --profile other_profile --delete-generations old
```
