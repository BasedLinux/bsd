...
const redirects = {
 "index.html": {
    ...
    "chap-writing-bsd-expressions": "language/index.html",
    ...
    "opt-out-link": "command-ref/bsd-build.html#opt-out-link",
    "sec-bsd-build": "command-ref/bsd-build.html",
    "sec-bsd-channel": "command-ref/bsd-channel.html",
    "sec-bsd-collect-garbage": "command-ref/bsd-collect-garbage.html",
    "sec-bsd-copy-closure": "command-ref/bsd-copy-closure.html",
    "sec-bsd-daemon": "command-ref/bsd-daemon.html",
    "refsec-bsd-env-install-examples": "command-ref/bsd-env.html#examples",
    "rsec-bsd-env-install": "command-ref/bsd-env.html#operation---install",
    "rsec-bsd-env-set": "command-ref/bsd-env.html#operation---set",
    "rsec-bsd-env-set-flag": "command-ref/bsd-env.html#operation---set-flag",
    "rsec-bsd-env-upgrade": "command-ref/bsd-env.html#operation---upgrade",
    "sec-bsd-env": "command-ref/bsd-env.html",
    "ssec-version-comparisons": "command-ref/bsd-env.html#versions",
    "sec-bsd-hash": "command-ref/bsd-hash.html",
    "sec-bsd-instantiate": "command-ref/bsd-instantiate.html",
    "sec-bsd-prefetch-url": "command-ref/bsd-prefetch-url.html",
    "sec-bsd-shell": "command-ref/bsd-shell.html",
    "ssec-bsd-shell-shebang": "command-ref/bsd-shell.html#use-as-a--interpreter",
    "bsdref-queries": "command-ref/bsd-store.html#queries",
    "opt-add-root": "command-ref/bsd-store.html#opt-add-root",
    "refsec-bsd-store-dump": "command-ref/bsd-store.html#operation---dump",
    "refsec-bsd-store-export": "command-ref/bsd-store.html#operation---export",
    "refsec-bsd-store-import": "command-ref/bsd-store.html#operation---import",
    "refsec-bsd-store-query": "command-ref/bsd-store.html#operation---query",
    "refsec-bsd-store-verify": "command-ref/bsd-store.html#operation---verify",
    "rsec-bsd-store-gc": "command-ref/bsd-store.html#operation---gc",
    "rsec-bsd-store-generate-binary-cache-key": "command-ref/bsd-store.html#operation---generate-binary-cache-key",
    "rsec-bsd-store-realise": "command-ref/bsd-store.html#operation---realise",
    "rsec-bsd-store-serve": "command-ref/bsd-store.html#operation---serve",
    "sec-bsd-store": "command-ref/bsd-store.html",
    ...
    "sec-bsd-ssl-cert-file": "installation/env-variables.html#bsd_ssl_cert_file",
    "sec-bsd-ssl-cert-file-with-bsd-daemon-and-macos": "installation/env-variables.html#bsd_ssl_cert_file-with-macos-and-the-bsd-daemon",
    ...
    "sect-bsd-install-binary-tarball": "installation/installing-binary.html#installing-from-a-binary-tarball",
    "sect-bsd-install-pinned-version-url": "installation/installing-binary.html#installing-a-pinned-bsd-version-from-a-url",
    ...
    "ch-bsd-security": "installation/bsd-security.html",
    "sec-obtaining-source": "installation/obtaining-source.html",
    "sec-prerequisites-source": "installation/prerequisites-source.html",
    "sec-single-user": "installation/single-user.html",
    "ch-supported-platforms": "installation/supported-platforms.html",
    "ch-upgrading-bsd": "installation/upgrading.html",
    "ch-about-bsd": "introduction.html",
    "chap-introduction": "introduction.html",
    "ch-basic-package-mgmt": "package-management/basic-package-mgmt.html",
    "ssec-binary-cache-substituter": "package-management/binary-cache-substituter.html",
    "sec-channels": "command-ref/bsd-channel.html",
    "ssec-copy-closure": "command-ref/bsd-copy-closure.html",
  ...
  "development/building.html": {
    "bsd-with-flakes": "#building-bsd-with-flakes",
    "classic-bsd": "#building-bsd",
