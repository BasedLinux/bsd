...
/**
 * @file
 * @brief Common printing functions for the Bsd language
 *
...
/**
 * Print a string as a Bsd string literal.
 *
...
/**
 * Print a string as an attribute name in the Bsd expression language syntax.
 *
...
/**
 * Print a string as an identifier in the Bsd expression language syntax.
 *
