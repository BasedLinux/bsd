...
namespace bsd { class Store; class StorePath; struct SourceAccessor; }
...
public:
    ...
    /**
     * Fetch the entire input into the Bsd store, returning the
     * location in the Bsd store and the locked input.
     */
...
public:
     ...
     *
     * This is not a stable identifier between Bsd versions, but not guaranteed to change either.
     */
 ...
 * registers with bsd at startup time.  When processing an `Input`,
