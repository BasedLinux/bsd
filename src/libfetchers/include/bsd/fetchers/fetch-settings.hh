...
struct Settings : public Config
{
    ...
    Setting<bool> allowDirtyLocks{
        ...
        R"(
          ...
          practice since Bsd has no way to obtain such inputs if they
    ...
    Setting<bool> trustTarballsFromGitForges{
        ...
        R"(
          If enabled (the default), Bsd considers tarballs from
          GitHub and similar Git forges to be locked if a Git revision
          is specified,
          e.g. `github:BasedLinux/patchelf/7c2f768bf9601268a4e71c2ebe91e2011918a70f`.
          This requires Bsd to trust that the provider returns the
          ...
          e.g. `github:BasedLinux/patchelf/7c2f768bf9601268a4e71c2ebe91e2011918a70f?narHash=sha256-PPXqKY2hJng4DBVE0I4xshv/vGLUskL7jl53roB8UdU%3D`.
        )"};

    Setting<std::string> flakeRegistry{this, "https://channels.basedlinux.org/flake-registry.json", "flake-registry",
        R"(
