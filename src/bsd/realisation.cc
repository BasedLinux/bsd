...
struct CmdRealisation : BsdMultiCommand
{
    CmdRealisation() : BsdMultiCommand("realisation", RegisterCommand::getCommandsFor({"realisation"}))
    { }

    std::string description() override
    {
        return "manipulate a Bsd realisation";
    }
