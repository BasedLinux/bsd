 ...
 * @file
 *
 * @brief This file defines two main structs/classes used in bsd error handling.
 *
 * ErrorInfo provides a standard payload of error information, with conversion to string
 * happening in the logger rather than at the call site.
 *
 * BaseError is the ancestor of bsd specific exceptions (and Interrupted), and contains
 * an ErrorInfo.
 *
 ...
 * function on Ubsd, and `GetLastError()`-based error handling on on
 * Windows.
 */
 ...
 */
#define unreachable() (::bsd::panic(__FILE__, __LINE__, __func__))
