 ...
 *
 * On Ubsd, this is just a regular anonymous pipe. On Windows, this has
...
/**
 * Use pool() (Ubsd) / I/O Completion Ports (Windows) to wait for the
...
struct MuxablePipePollState
{
    ...
    /**
     * Check for ready (Ubsd) / completed (Windows) operations
     */
    void poll(
#ifdef _WIN32
        HANDLE ioport,
    ...
    /**
     * Process for ready (Ubsd) / completed (Windows) operations,
