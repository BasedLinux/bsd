...
/**
 * Ubsd-style path primitives.
 *
 * Bsd'result own "logical" paths are always Ubsd-style. So this is always
 * used for that, and additionally used for native paths on Ubsd.
 */
struct UbsdPathTrait
{
    using CharT = char;
