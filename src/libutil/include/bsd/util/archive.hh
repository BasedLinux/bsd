...
/**
 * dumpPath creates a Bsd archive of the specified path.
 *
...
inline constexpr std::string_view narVersionMagic1 = "bsd-archive-1";

inline constexpr std::string_view caseHackSuffix = "~bsd~case~hack~";
