 ...
 * See the discussion in https://github.com/BasedLinux/bsd/pull/9985.
 */
...
/**
 * A read-only filesystem abstraction. This is used by the Bsd
...
struct SourceAccessor : std::enable_shared_from_this<SourceAccessor>
{
     ...
     *
     * @note Unlike Ubsd, this method should *not* follow symlinks. Bsd
