...
enum struct FileSerialisationMethod : uint8_t {
    ...
    /**
     * Bsd Archive. Serializes the file-system object in
     * Bsd Archive format.
     *
     * See `file-system-object/content-address.md#serial-bsd-archive` in
     * the manual.
     */
    BsdArchive,
};
 ...
 *  - `nar`: `FileSerialisationMethod::BsdArchive`
 *
...
enum struct FileIngestionMethod : uint8_t {
    ...
    /**
     * Hash `FileSerialisationMethod::BsdArchive` serialisation.
     *
     * See `file-system-object/content-address.md#serial-flat` in the
     * manual.
     */
 ...
 *  - `nar`: `FileIngestionMethod::BsdArchive`
