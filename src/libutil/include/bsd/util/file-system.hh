 ...
 */
Path createTempDir(const Path & tmpRoot = "", const Path & prefix = "bsd",
                   mode_t mode = 0755);

/**
 * Create a temporary file, returning a file handle and its path.
 */
std::pair<AutoCloseFD, Path> createTempFile(const Path & prefix = "bsd");
...
/**
  ...
  * but throws BsdError on failure instead of std::filesystem::filesystem_error.
  */
