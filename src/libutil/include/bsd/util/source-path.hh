...
struct SourcePath
{
    ...
    */
    ...
    friend class std::hash<bsd::SourcePath>;
};
...
template<>
struct std::hash<bsd::SourcePath>
{
    std::size_t operator()(const bsd::SourcePath & s) const noexcept
    {
        std::size_t hash = 0;
