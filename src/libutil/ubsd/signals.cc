...
std::atomic<bool> ubsd::_isInterrupted = false;

namespace ubsd {
static thread_local bool interruptThrown = false;
}

thread_local std::function<bool()> ubsd::interruptCheck;

void setInterruptThrown()
{
    ubsd::interruptThrown = true;
}

void ubsd::_interrupted()
{
...
void ubsd::setChildSignalMask(sigset_t * sigs)
{
...
void ubsd::startSignalHandlerThread()
{
    updateWindowSize();
...
void ubsd::restoreSignals()
{
    ...
    //       I don't know what the larger ubsd ecosystem expects from us here.
