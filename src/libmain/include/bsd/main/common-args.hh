...
struct MixPrintJSON : virtual Args
{
     ...
     * about extensibility, https://basedlinux.org/manual/bsd/development/development/json-guideline.html -
...
struct MixRepair : virtual Args
{
    ...
    MixRepair()
    {
        addFlag({
            .longName = "repair",
            .description =
                "During evaluation, rewrite missing or corrupted files in the Bsd store. "
