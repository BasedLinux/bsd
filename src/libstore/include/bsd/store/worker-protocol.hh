...
/**
 * The "worker protocol", used by ubsd:// and ssh-ng:// stores.
 *
...
enum struct WorkerProto::Op : uint64_t
{
    ...
    QueryReferrers = 6,
    AddToStore = 7,
    AddTextToStore = 8, // obsolete since 1.25, Bsd 3.0. Use WorkerProto::Op::AddToStore
    BuildPaths = 9,
    EnsurePath = 10,
    AddTempRoot = 11,
    AddIndirectRoot = 12,
