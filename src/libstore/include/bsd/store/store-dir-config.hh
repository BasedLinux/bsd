...
struct MixStoreDirMethods
{
    ...
    /**
     * @return true if *path* is in the Bsd store (but not the Bsd
     * store itself).
     */
    ...
    std::pair<StorePath, Hash> computeStorePath(
        ...
        ContentAddressMethod method = FileIngestionMethod::BsdArchive,
...
struct StoreDirConfigBase : Config
{
    ...
    const PathSetting storeDir_{this, settings.bsdStore,
        "store",
        R"(
          Logical location of the Bsd store, usually
