...
/**
 * \ref StorePath "Store path" is the fundamental reference type of Bsd.
...
/**
 * The file extension of \ref bsd::Derivation derivations when serialized
 * into store objects.
 */
...
template<> struct hash<bsd::StorePath> {
    std::size_t operator()(const bsd::StorePath & path) const noexcept
    {
