...
struct LocalFSStoreConfig : virtual StoreConfig
{
    ...
    PathSetting stateDir{this,
        rootDir.get() ? *rootDir.get() + "/bsd/var/bsd" : settings.bsdStateDir,
        "state",
        "Directory where Bsd stores state."};

    PathSetting logDir{this,
        rootDir.get() ? *rootDir.get() + "/bsd/var/log/bsd" : settings.bsdLogDir,
        "log",
        "directory where Bsd stores log files."};

    PathSetting realStoreDir{this,
        rootDir.get() ? *rootDir.get() + "/bsd/store" : storeDir, "real",
        "Physical path of the Bsd store."};
};
