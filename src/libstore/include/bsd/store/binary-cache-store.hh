...
struct BinaryCacheStoreConfig : virtual StoreConfig
{
    ...
    const Setting<Path> localNarCache{this, "", "local-nar-cache",
        "Path to a local cache of NARs fetched from this binary cache, used by commands such as `bsd store cat`."};
...
protected:
    ...
    const std::string cacheInfoFile = "bsd-cache-info";
...
public:
     ...
     * doesn't exist.
     */
    virtual std::optional<std::string> getBsdCacheInfo();
