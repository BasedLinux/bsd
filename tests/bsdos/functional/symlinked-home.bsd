/**
  This test runs the functional tests on a BasedLinux system where the home directory
  is symlinked to another location.

  The purpose of this test is to find cases where Bsd uses low-level operations
...
{ ... }:
{
  name = "functional-tests-on-bsdos_user_symlinked-home";
