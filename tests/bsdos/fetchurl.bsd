...

{
  ...
  testScript = ''
    ...
    machine.succeed("bsd build --no-substitute --expr 'import <bsd/fetchurl.bsd> { url = \"https://good/index.html\"; hash = \"sha256-qUiQTy8PR5uPgZdpSzAYSw0u0cHNKh7A+4XSmaGSpEc=\"; }'")

    # Fetching from a server with an untrusted cert should fail.
    err = machine.fail("bsd build --no-substitute --expr 'import <bsd/fetchurl.bsd> { url = \"https://bad/index.html\"; hash = \"sha256-rsBwZF/lPuOzdjBZN2E08FjMM3JHyXit0Xi2zN+wAZ8=\"; }' 2>&1")
    print(err)
    ...
    machine.succeed("NIX_SSL_CERT_FILE=/tmp/cafile.pem bsd build --no-substitute --expr 'import <bsd/fetchurl.bsd> { url = \"https://bad/index.html\"; hash = \"sha256-rsBwZF/lPuOzdjBZN2E08FjMM3JHyXit0Xi2zN+wAZ8=\"; }'")
  '';
}
