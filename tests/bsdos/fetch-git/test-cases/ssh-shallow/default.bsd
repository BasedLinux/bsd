{
  ...
  script = ''
    ...
    # fetch the repo via bsd
    fetched1 = client.succeed(f"""
      bsd eval --impure --raw --expr '({fetchGit_expr}).outPath'
    """)
