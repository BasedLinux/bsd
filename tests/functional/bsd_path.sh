...
bsd-instantiate --eval -E '<by-absolute-path/simple.bsd>' --restrict-eval
bsd-instantiate --eval -E '<by-relative-path/simple.bsd>' --restrict-eval
...
[[ $(bsd-instantiate --find-file by-absolute-path/simple.bsd) = $PWD/simple.bsd ]]
[[ $(bsd-instantiate --find-file by-relative-path/simple.bsd) = $PWD/simple.bsd ]]
...
(! NIX_PATH=test=$TEST_ROOT bsd-instantiate --find-file test/only-from-bsd-path-file.bsd)

# -I extends bsd.conf
[[ $(bsd-instantiate -I test=$TEST_ROOT/from-I --find-file test/only-from-I.bsd) = $TEST_ROOT/from-I/only-from-I.bsd ]]
# if -I does not have the desired entry, the value from bsd.conf is used
[[ $(bsd-instantiate -I test=$TEST_ROOT/from-I --find-file test/only-from-bsd-path-file.bsd) = $TEST_ROOT/from-bsd-path-file/only-from-bsd-path-file.bsd ]]

# -I extends NIX_PATH
[[ $(NIX_PATH=test=$TEST_ROOT/from-NIX_PATH bsd-instantiate -I test=$TEST_ROOT/from-I --find-file test/only-from-I.bsd) = $TEST_ROOT/from-I/only-from-I.bsd ]]
...
[[ $(NIX_PATH=test=$TEST_ROOT/from-NIX_PATH bsd-instantiate -I test=$TEST_ROOT/from-I --find-file test/only-from-NIX_PATH.bsd) = $TEST_ROOT/from-NIX_PATH/only-from-NIX_PATH.bsd ]]

# --extra-bsd-path extends NIX_PATH
[[ $(NIX_PATH=test=$TEST_ROOT/from-NIX_PATH bsd-instantiate --extra-bsd-path test=$TEST_ROOT/from-extra-bsd-path --find-file test/only-from-extra-bsd-path.bsd) = $TEST_ROOT/from-extra-bsd-path/only-from-extra-bsd-path.bsd ]]
# if --extra-bsd-path does not have the desired entry, the value from NIX_PATH is used
[[ $(NIX_PATH=test=$TEST_ROOT/from-NIX_PATH bsd-instantiate --extra-bsd-path test=$TEST_ROOT/from-extra-bsd-path --find-file test/only-from-NIX_PATH.bsd) = $TEST_ROOT/from-NIX_PATH/only-from-NIX_PATH.bsd ]]
...
(! NIX_PATH=test=$TEST_ROOT/from-NIX_PATH bsd-instantiate --bsd-path test=$TEST_ROOT/from-bsd-path --find-file test/only-from-NIX_PATH.bsd)

# --bsd-path overrides bsd.conf
[[ $(bsd-instantiate --bsd-path test=$TEST_ROOT/from-bsd-path --find-file test) = $TEST_ROOT/from-bsd-path ]]
(! bsd-instantiate --bsd-path test=$TEST_ROOT/from-bsd-path --find-file test/only-from-bsd-path-file.bsd)

# --extra-bsd-path extends bsd.conf
[[ $(bsd-instantiate --extra-bsd-path test=$TEST_ROOT/from-extra-bsd-path --find-file test/only-from-extra-bsd-path.bsd) = $TEST_ROOT/from-extra-bsd-path/only-from-extra-bsd-path.bsd ]]
...
# -I extends --bsd-path
[[ $(bsd-instantiate --bsd-path test=$TEST_ROOT/from-bsd-path -I test=$TEST_ROOT/from-I --find-file test/only-from-I.bsd) = $TEST_ROOT/from-I/only-from-I.bsd ]]
[[ $(bsd-instantiate --bsd-path test=$TEST_ROOT/from-bsd-path -I test=$TEST_ROOT/from-I --find-file test/only-from-bsd-path.bsd) = $TEST_ROOT/from-bsd-path/only-from-bsd-path.bsd ]]
