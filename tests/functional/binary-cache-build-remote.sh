...
(! bsd-build --store "file://$cacheDir" dependencies.bsd)

# Succeeds with default store as build remote.
outPath=$(bsd-build --store "file://$cacheDir" --builders 'auto - - 1 1' -j0 dependencies.bsd)
...
bsd-build --store "file://$cacheDir" -j0 dependencies.bsd
