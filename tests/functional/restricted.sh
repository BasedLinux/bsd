...
(! bsd-instantiate --eval --restrict-eval ./restricted.nix)
...
bsd-instantiate --restrict-eval ./simple.nix -I src=.
bsd-instantiate --restrict-eval ./simple.nix -I src1=./simple.nix -I src2=./config.nix -I src3=./simple.builder.sh

# no default NIX_PATH
(unset NIX_PATH; ! bsd-instantiate --restrict-eval --find-file .)

(! bsd-instantiate --restrict-eval --eval -E 'builtins.readFile ./simple.nix')
bsd-instantiate --restrict-eval --eval -E 'builtins.readFile ./simple.nix' -I src=../..

expectStderr 1 bsd-instantiate --restrict-eval --eval -E 'let __bsdPath = [ { prefix = "foo"; path = ./.; } ]; in builtins.readFile <foo/simple.nix>' | grepQuiet "forbidden in restricted mode"
bsd-instantiate --restrict-eval --eval -E 'let __bsdPath = [ { prefix = "foo"; path = ./.; } ]; in builtins.readFile <foo/simple.nix>' -I src=.
...
[[ $(bsd-instantiate --eval $TEST_ROOT/restricted.nix) == 3 ]]
(! bsd-instantiate --eval --restrict-eval $TEST_ROOT/restricted.nix)
(! bsd-instantiate --eval --restrict-eval $TEST_ROOT/restricted.nix -I $TEST_ROOT)
(! bsd-instantiate --eval --restrict-eval $TEST_ROOT/restricted.nix -I .)
bsd-instantiate --eval --restrict-eval "$TEST_ROOT/restricted.nix" -I "$TEST_ROOT" -I "${_NIX_TEST_SOURCE_DIR}"

[[ $(bsd eval --raw --impure --restrict-eval -I . --expr 'builtins.readFile "${import ./simple.nix}/hello"') == 'Hello World!' ]]
...
expectStderr 1 bsd-instantiate --restrict-eval true ./dependencies.nix | grepQuiet "forbidden in restricted mode"
